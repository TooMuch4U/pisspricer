...
def image_base64_from_url(url):
    res = requests.get(url)
    image_file = process_response_content(res.content)
    return base64.b64encode(image_file)


def image_base64_from_content(content):
    image_file = process_response_content(content)
    return base64.b64encode(image_file)
